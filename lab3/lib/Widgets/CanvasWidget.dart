...
class CanvasPanel extends StatefulWidget {
  ...
  CanvasPanel({Key key, this.changeStatus, this.pickedColor, this.strokeWidth, this.isPressed}): super (key: key);

  @override
  CanvasPanelState createState() => CanvasPanelState();

}

class CanvasPanelState extends State<CanvasPanel> {
  ...
  void changeStatus(double strokeWidth, Color pickedColor) {
    this.widget.strokeWidth = strokeWidth;
    this.widget.pickedColor = pickedColor;
  }
