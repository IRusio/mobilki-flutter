...
import 'package:lab2app/src/app/Controllers/PhoneAppController.dart';
import 'package:lab2app/src/app/Models/PhoneList.dart';
...
class _Widgets {
  ...
  Widget get homePhonesTab => con.buildPhoneTab(
    con.context, HomeViewTab.home, PhoneAppController.phoneData.allPhones
  );
